...
function distributeHours(
  ...
  return [
    ...
    {
      key: "catchup",
      planned: catchupHours,
      completed: 0,
      catchup: catchupHours,
    },
...
function buildAttendance(
  ...
  if (student.id === "s1") {
    return [
      {
        date: "19/09/2026",
        sessionKey: "studentDetail.attendance.sessions.pedagogicalDay",
        status: "absent",
        missedHours: "7 h",
      },
      {
        date: "16/09/2026",
        sessionKey: "studentDetail.attendance.sessions.signageClass",
        status: "late",
        missedHours: "0,5 h",
      },
      {
        date: "12/09/2026",
        sessionKey: "studentDetail.attendance.sessions.driving",
        status: "present",
        missedHours: "—",
      },
      {
        date: "08/09/2026",
        sessionKey: "studentDetail.attendance.sessions.sheet30",
        status: "present",
        missedHours: "—",
      },
    ];
  ...
  return [
    {
      date: "20/09/2026",
      sessionKey: "studentDetail.attendance.sessions.classroom",
      status: "present",
      missedHours: "—",
    },
    {
      date: "18/09/2026",
      sessionKey: "studentDetail.attendance.sessions.driving",
      status: hasDelay ? "late" : "present",
      missedHours: hasDelay ? "0,5 h" : "—",
    },
    {
      date: "15/09/2026",
      sessionKey: "studentDetail.attendance.sessions.presentation",
      status: hasAbsence ? "absent" : "present",
      missedHours: hasAbsence ? "4 h" : "—",
    },
  ];
}
...
function buildEvaluations(
  ...
  return [
    {
      date: "18/09/2026",
      titleKey: "studentDetail.evaluations.rows.sheet32",
      resultKey: mostlyPositive
        ? "studentDetail.evaluations.results.validated"
        : "studentDetail.evaluations.results.rework",
      tone: mostlyPositive ? "success" : "warning",
      evaluator: "Claire Berthier",
    },
    {
      date: "13/09/2026",
      titleKey: "studentDetail.evaluations.rows.drivingC1",
      resultKey: "studentDetail.evaluations.results.inProgress",
      tone: "warning",
      evaluator: "Marc Dupont",
    },
    {
      date: "17/07/2026",
      titleKey: "studentDetail.evaluations.rows.internshipReview",
      resultKey: "studentDetail.evaluations.results.validated",
      tone: "success",
      evaluator: "Émilie Rocher",
    },
    {
      date: "04/06/2026",
      titleKey: "studentDetail.evaluations.rows.intermediateC2",
      resultKey: mostlyPositive
        ? "studentDetail.evaluations.results.acquired"
        : "studentDetail.evaluations.results.inProgress",
      tone: mostlyPositive ? "success" : "warning",
      evaluator: "Sophie Lemaire",
    },
  ];
}
...
function buildDocuments(student: StudentDirectoryItem): StudentDocumentRow[] {
  return [
    {
      id: `${student.id}-d1`,
      titleKey: "studentDetail.documents.rows.internshipAgreement",
      categoryKey: "documents.categories.internship",
      date: "28/05/2026",
      size: "182 Ko",
    },
    {
      id: `${student.id}-d2`,
      titleKey: "studentDetail.documents.rows.remc",
      categoryKey: "documents.categories.pedagogical",
      date: "01/09/2026",
      size: "1,4 Mo",
    },
    {
      id: `${student.id}-d3`,
      titleKey: "studentDetail.documents.rows.drivingGrid",
      categoryKey: "documents.categories.evaluation",
      date: "04/09/2026",
      size: "96 Ko",
    },
    {
      id: `${student.id}-d4`,
      titleKey: "studentDetail.documents.rows.intersectionsSupport",
      categoryKey: "documents.categories.course",
      date: "18/09/2026",
      size: "3,2 Mo",
    },
    {
      id: `${student.id}-d5`,
      titleKey: "studentDetail.documents.rows.internalRules",
      categoryKey: "documents.categories.administrative",
      date: "25/08/2026",
      size: "240 Ko",
    },
  ];
...
function buildTimeline(student: StudentDirectoryItem): StudentTimelineRow[] {
  if (student.id === "s1") {
    return [
      {
        dateKey: "studentDetail.timeline.18sep",
        titleKey: "studentDetail.timeline.sheet32",
        detailKey: "studentDetail.timeline.bends",
        tone: "success",
      },
      {
        dateKey: "studentDetail.timeline.19sep",
        titleKey: "studentDetail.timeline.absence",
        detailKey: "studentDetail.timeline.catchup7",
        tone: "danger",
      },
      {
        dateKey: "studentDetail.timeline.20sep",
        titleKey: "studentDetail.timeline.driving",
        detailKey: "studentDetail.timeline.drivingDetail",
        tone: "warning",
      },
      {
        dateKey: "studentDetail.timeline.21sep",
        titleKey: "studentDetail.timeline.classroom",
        detailKey: "studentDetail.timeline.classroomDetail",
        tone: "info",
      },
    ];
  }
  ...
  return [
    {
      dateKey: "studentDetail.timeline.18sep",
      titleKey: "studentDetail.timeline.presentation",
      detailKey: "studentDetail.timeline.presentationDetail",
      tone: "success",
    },
    {
      dateKey: "studentDetail.timeline.20sep",
      titleKey: "studentDetail.timeline.driving",
      detailKey: "studentDetail.timeline.genericDrivingDetail",
      tone: "warning",
    },
    {
      dateKey: "studentDetail.timeline.21sep",
...
export function studentDetailById(
  id: string,
  ...
  return {
    ...
    reworkSheets:
      student.id === "s1"
        ? 6
        : Math.max(1, Math.round(student.preparedSheets * 0.16)),
...
export function studentAuditHistory(id: string) {
  ...
  if (id === "s2")
    return AUDIT_LOG.filter((item) => item.id === "a3" || item.id === "a4");
