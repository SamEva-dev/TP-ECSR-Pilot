...
export const SKILL_DEFINITIONS: SkillDefinition[] = [
  {
    ...
    criteria: [
      { labelKey: 'skills.definitions.C1.criteria.prepareIndividual', level: 'acquired' },
      { labelKey: 'skills.definitions.C1.criteria.leadDrivingLesson', level: 'acquired' },
      { labelKey: 'skills.definitions.C1.criteria.assessLearner', level: 'acquired' },
      { labelKey: 'skills.definitions.C1.criteria.learningRecord', level: 'acquired' },
    ],
  },
  {
    code: 'C2',
    ...
    criteria: [
      { labelKey: 'skills.definitions.C2.criteria.buildSheet', level: 'acquired' },
      { labelKey: 'skills.definitions.C2.criteria.leadGroup', level: 'acquired' },
      { labelKey: 'skills.definitions.C2.criteria.questioningMethod', level: 'in_progress' },
      { labelKey: 'skills.definitions.C2.criteria.timeRip', level: 'in_progress' },
    ],
  },
  {
    code: 'C3',
    ...
    criteria: [
      { labelKey: 'skills.definitions.C3.criteria.bendsGradients', level: 'in_progress' },
      { labelKey: 'skills.definitions.C3.criteria.expressway', level: 'rework' },
      { labelKey: 'skills.definitions.C3.criteria.urban', level: 'rework' },
      { labelKey: 'skills.definitions.C3.criteria.ecoDriving', level: 'rework' },
    ],
  },
  {
    code: 'C4',
    ...
    criteria: [
      { labelKey: 'skills.definitions.C4.criteria.awarenessAction', level: 'in_progress' },
