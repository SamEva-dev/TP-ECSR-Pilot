export type InternshipStatus = 'completed' | 'incomplete' | 'inProgress' | 'planned';
...
export const INTERNSHIP_PERIODS: InternshipPeriod[] = [
  {
    ...
    trainerVisible: true,
    activities: [
      { labelKey: 'internships.activities.observeDrivingLessons', status: 'done' },
      { labelKey: 'internships.activities.leadTheorySession', status: 'done' },
      { labelKey: 'internships.activities.pedagogicalAppointment', status: 'done' },
      { labelKey: 'internships.activities.lessonPlan', status: 'done' },
      { labelKey: 'internships.activities.studentInitialAssessment', status: 'done' },
    ],
    tutorObservationKey: 'internships.observations.sam',
    documents: [
      { labelKey: 'internships.documents.agreement', status: 'available' },
      { labelKey: 'internships.documents.attendanceCertificate', status: 'available' },
  ...
  },
  {
    ...
    activities: [
      ...
      { labelKey: 'internships.activities.studentInitialAssessment', status: 'pending' },
    ],
    tutorObservationKey: 'internships.observations.julie',
    documents: [
      { labelKey: 'internships.documents.agreement', status: 'available' },
      { labelKey: 'internships.documents.attendanceCertificate', status: 'missing' },
  ...
  },
  {
    ...
    activities: [
      { labelKey: 'internships.activities.observeDrivingLessons', status: 'done' },
      { labelKey: 'internships.activities.leadTheorySession', status: 'pending' },
      { labelKey: 'internships.activities.pedagogicalAppointment', status: 'pending' },
      { labelKey: 'internships.activities.lessonPlan', status: 'done' },
      { labelKey: 'internships.activities.studentInitialAssessment', status: 'pending' },
    ],
  ...
  },
  {
    ...
    activities: [
      { labelKey: 'internships.activities.observeDrivingLessons', status: 'pending' },
      { labelKey: 'internships.activities.leadTheorySession', status: 'pending' },
      { labelKey: 'internships.activities.pedagogicalAppointment', status: 'pending' },
      { labelKey: 'internships.activities.lessonPlan', status: 'pending' },
      { labelKey: 'internships.activities.studentInitialAssessment', status: 'pending' },
