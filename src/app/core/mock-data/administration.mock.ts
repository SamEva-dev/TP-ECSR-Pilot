...
export const ACCESS_ROLE_SUMMARIES: AccessRoleSummary[] = [
  {
    ...
    icon: "ph-users-three",
    tone: "blue",
    descriptionKey: "administration.access.direction",
  },
  {
    role: "formateur",
    icon: "ph-users-three",
    tone: "blue",
    descriptionKey: "administration.access.formateur",
  },
  {
    role: "stagiaire",
    icon: "ph-users-three",
    tone: "green",
    descriptionKey: "administration.access.stagiaire",
  },
  {
    role: "secretariat",
    icon: "ph-users-three",
    tone: "amber",
    descriptionKey: "administration.access.secretariat",
  },
];
...
export const RECENT_ADMIN_ACTIONS: RecentAdminAction[] = [
  {
    id: "r1",
    titleKey: "administration.recent.samHours.title",
    metaKey: "administration.recent.samHours.meta",
  },
  {
    id: "r2",
    titleKey: "administration.recent.sheet32.title",
    metaKey: "administration.recent.sheet32.meta",
  },
];
