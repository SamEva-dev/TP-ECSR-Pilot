...
export const CENTER_PROMOTIONS: StatisticsPromotionRow[] = [
  { id: 'p1', name: 'TP ECSR 2026–2027', progress: 69, completedHours: 5699, plannedHours: 8190, attendance: 96, catchupHours: 60 },
  { id: 'p2', name: 'TP ECSR 2025–2026', progress: 69, completedHours: 3776, plannedHours: 5460, attendance: 95, catchupHours: 42 },
];
...
export const SECRETARIAT_PRIORITIES = [
  { name: 'Thomas Roussel', detailKey: 'statistics.secretariat.priorities.catchup', value: 18 },
  { name: 'Julie Moreau', detailKey: 'statistics.secretariat.priorities.catchup', value: 14 },
  { name: 'Léa Perrin', detailKey: 'statistics.secretariat.priorities.catchup', value: 12 },
  { name: 'Sarah Colin', detailKey: 'statistics.secretariat.priorities.absence', value: 2 },
];
