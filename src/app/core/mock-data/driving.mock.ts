...
export const DRIVING_SUB_SKILLS: Record<'C1' | 'C2' | 'C3' | 'C4', { id: string; labelKey: string }[]> = {
  C1: [
...
export const DRIVING_HISTORY: DrivingHistoryItem[] = [
  {
    id: 'dh1', studentId: 's1', studentName: 'Sam Fokam', date: '20/09/2026', competence: 'C3', trainer: 'Marc Dupont',
    subjectKey: 'drivingSession.history.bends.subject', positiveKey: 'drivingSession.history.bends.positive', difficultyKey: 'drivingSession.history.bends.difficulty', nextGoalKey: 'drivingSession.history.bends.nextGoal',
    evaluations: [
      { criterionId: 'information', level: 'acquired' }, { criterionId: 'speed', level: 'progress' }, { criterionId: 'position', level: 'acquired' },
      { criterionId: 'gaze', level: 'work' }, { criterionId: 'anticipation', level: 'progress' }, { criterionId: 'communication', level: 'acquired' },
    ],
  },
  {
    id: 'dh2', studentId: 's2', studentName: 'Julie Moreau', date: '20/09/2026', competence: 'C3', trainer: 'Sophie Lemaire',
    subjectKey: 'drivingSession.history.expressway.subject', positiveKey: 'drivingSession.history.expressway.positive', difficultyKey: 'drivingSession.history.expressway.difficulty', nextGoalKey: 'drivingSession.history.expressway.nextGoal',
    evaluations: [
      { criterionId: 'information', level: 'progress' }, { criterionId: 'speed', level: 'acquired' }, { criterionId: 'position', level: 'progress' },
      { criterionId: 'gaze', level: 'progress' }, { criterionId: 'anticipation', level: 'work' }, { criterionId: 'communication', level: 'acquired' },
    ],
  },
  {
    id: 'dh3', studentId: 's1', studentName: 'Sam Fokam', date: '13/09/2026', competence: 'C1', trainer: 'Marc Dupont',
    subjectKey: 'drivingSession.history.lesson.subject', positiveKey: 'drivingSession.history.lesson.positive', difficultyKey: 'drivingSession.history.lesson.difficulty', nextGoalKey: 'drivingSession.history.lesson.nextGoal',
    evaluations: [
      { criterionId: 'information', level: 'acquired' }, { criterionId: 'speed', level: 'acquired' }, { criterionId: 'position', level: 'acquired' },
      { criterionId: 'gaze', level: 'progress' }, { criterionId: 'anticipation', level: 'acquired' }, { criterionId: 'communication', level: 'progress' },
    ],
  },
  {
    id: 'dh4', studentId: 's5', studentName: 'Karim Benali', date: '19/09/2026', competence: 'C3', trainer: 'Sophie Lemaire',
    subjectKey: 'drivingSession.history.urban.subject', positiveKey: 'drivingSession.history.urban.positive', difficultyKey: 'drivingSession.history.urban.difficulty', nextGoalKey: 'drivingSession.history.urban.nextGoal',
    evaluations: [
      { criterionId: 'information', level: 'acquired' }, { criterionId: 'speed', level: 'acquired' }, { criterionId: 'position', level: 'progress' },
      { criterionId: 'gaze', level: 'acquired' }, { criterionId: 'anticipation', level: 'progress' }, { criterionId: 'communication', level: 'acquired' },
    ],
  },
];
